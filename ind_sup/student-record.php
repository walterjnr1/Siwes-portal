...
{ ?>
                ...
                <td>  <div align="center"> <?php if($row['status']=="0"){ ?>
          <a href="Deactivate-activate-student.php?id=<?php echo $row['ID'];?>" onClick="return Activate('<?php echo $row['fullname']; ?>');"><i class="fa fa-check" title="Approve Student Account"></i> </a>
         <?php } else {?><a href="Deactivate-activate-student.php?did=<?php echo $row['ID'];?>" onClick="return Deactivate('<?php echo $row['fullname']; ?>');"><i class="fa fa-times" title="Deactivate Student Account"></i> </a>
           <?php } ?><a href="delete-student.php?rid=<?php echo $row['reg_num'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');">Delete </a>                                            </div></td>
