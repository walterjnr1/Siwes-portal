...
$comment = mysqli_real_escape_string($conn,$_POST['cmdcomment']);

   $sql = "update  upload_logbook set `comment`='$comment' where reg_num= '$id' and log_week= '$wid'";
  $res = $conn->query($sql);
  
?>
  <script>
    //alert('Password changed Successfully...');
    window.location ="logbook-record.php";
  </script> 
  <?php
    }
//  }
...
<title>Add Comment|<?php echo $row_website['website_name'];   ?> </title>
...
<div class="wrapper boxed-wrapper">
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i>Comment</li>
      </ol>
    </div>
    			<?php if($success){?>
        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">Add Comment</h5>
            </div>
            <div class="card-body">
                                <form role="form" method="POST">
              <div class="form-group">
                <label for="exampleInputEmail1">Comment</label>
<select name="cmdcomment"  id="cmdcomment" class="form-control" >
