            ...
            <tr>
						...
						<th><div align="center">Student Name</div></th>
						 ...
						 <th><div align="center">Session </div></th>
                          <th><div align="center">Attendance </div></th>
                          <th><div align="center">Punctuality </div></th>
                          <th><div align="center">Performance </div></th>
                          <th><div align="center">Relationship </div></th>
                          <th><div align="center">Logbook </div></th>
                          <th><div align="center">Physical Presence </div></th>
                          <th><div align="center">Interview </div></th>
                          <th><div align="center">Technical Report </div></th>
                          <th><div align="center">Defense </div></th>
           ...
           <tr>
					...
					<td><div align="center"><img src="<?php echo (!empty($row['photo'])) ? $row['photo'] : 'dist/img/No_image_available.svg.png'; ?>"  width="73" height="61" border="2"/></div></td>
                          <td><div align="center"><?php echo $row['fullname']; ?></div></td>
						    ...
						    <td><div align="center"><?php echo $row['attendance_score']; ?></div></td>
                             <td><div align="center"><?php echo $row['punctuality_score'] ?></div></td>
                             <td><div align="center"><?php echo $row['performance_score'] ?></div></td>
                             <td><div align="center"><?php echo $row['relationship_score'] ?></div></td>
                             <td><div align="center"><?php echo $row['logbook_score'] ?></div></td>
                             <td><div align="center"><?php echo $row['physicalpresence_score'] ?></div></td>
                             <td><div align="center"><?php echo $row['interview_score'] ?></div></td>
                             <td><div align="center"><?php echo $row['report_score'] ?></div></td>
                             <td><div align="center"><?php echo $row['defense_score'] ?></div></td>
s                             <td><div align="center"><?php echo $row['total_score'] ?></div></td>
