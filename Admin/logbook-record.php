	 ...
	 <p> </p>
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
    <?php 
$data = $dbh->query("SELECT * FROM tblstudent INNER JOIN upload_logbook ON tblstudent.reg_num=upload_logbook.reg_num where upload_logbook.comment !='' ORDER BY upload_logbook.date_upload ASC")->fetchAll();
$cnt=1;
foreach ($data as $row) {
